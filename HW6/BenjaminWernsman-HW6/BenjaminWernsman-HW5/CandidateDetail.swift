...
class CandidateDetail: UIViewController {
    ...
    override func viewWillAppear(animated: Bool) {
        first_name.text! = candidateManager.candidates[indexTapped].first_name
        last_name.text! = candidateManager.candidates[indexTapped].last_name
        state.text! = candidateManager.candidates[indexTapped].state
        party.text! = candidateManager.candidates[indexTapped].party
        votes.text! = String(candidateManager.candidates[indexTapped].votes)
    }
